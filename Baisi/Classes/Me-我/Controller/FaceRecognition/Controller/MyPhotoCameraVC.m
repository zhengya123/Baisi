...
@interface MyPhotoCameraVC ()<AVCaptureMetadataOutputObjectsDelegate,UIAlertViewDelegate>
...
@implementation MyPhotoCameraVC
...
- (void)customUI{
    ...
    GoodBtn.frame = CGRectMake(10, kScreenHeight-100, 60, 60);
    [GoodBtn setTitle:@"OK" forState:UIControlStateNormal];
    ...
    leftButton.frame = CGRectMake((kScreenWidth*1/2.0-30)/2, kScreenHeight-100, 60, 60);
    ...
    rightButton.frame = CGRectMake(kScreenWidth*1/2.0 + 50, kScreenHeight-100, 60, 60);
   ...
   // [_flashButton setTitle:@"闪光灯关" forState:UIControlStateNormal];
    [_flashButton setImage:[UIImage imageNamed:@"flash_icon"] forState:UIControlStateNormal];
    ...
    if ([_device lockForConfiguration:nil]) {
        if (_isflashOn) {
            ...
            if ([_device isFlashModeSupported:AVCaptureFlashModeOn]) {
                ...
                [_flashButton setImage:[UIImage imageNamed:@"flash_icon1"] forState:UIControlStateNormal];
            }
        }
