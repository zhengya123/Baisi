...
-(NSArray *)dataArrays{
    if (_dataArrays == nil) {
        _dataArrays = @[@{ImageName:@"mine-icon-preview",TitleName:@"审帖"},
                       ...
                       @{ImageName:@"mine-icon-preview",TitleName:@"人脸识别"},
                       @{ImageName:@"mine-icon-preview",TitleName:@"人脸对比"},
                       @{ImageName:@"mine-icon-preview",TitleName:@"查询"},
                       @{ImageName:@"mine-icon-preview",TitleName:@"比较"},
                       @{ImageName:@"mine-icon-preview",TitleName:@"审帖"},
                       @{ImageName:@"mine-icon-preview",TitleName:@"审帖"},
                       @{ImageName:@"mine-icon-preview",TitleName:@"审帖"},
                       @{ImageName:@"mine-icon-preview",TitleName:@"审帖"},
